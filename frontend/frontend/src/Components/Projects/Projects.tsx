    ...
    <section className="py-32 px-6 lg:px-40 bg-plum-deep" id="projects">
      <motion.div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <ProjectCard title="Quantum" subtitle="Work Management Tool" imageUrl="/quantum.png" liveUrl="https://work-management-tool-three.vercel.app" githubUrl="https://github.com/JagritiChopra/Work-Management-Tool" variants={itemVariants} />
