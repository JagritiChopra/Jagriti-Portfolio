    ...
    <section className="py-32 px-6 lg:px-40 bg-plum-deep" id="projects">
      <motion.div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <ProjectCard title="LinkUp" subtitle="Real Time Chat App" imageUrl="https://lh3.googleusercontent.com/aida-public/AB6AXuDNtPhuI4swWrYmrw2yKHJ40XyX94CCZYr1W2ysvt8kSAp1tBG9oDZfHc_oxjVfn0s9o4CTpih-XukNpPM4EpC8-VvEgEvCi8ct6oZpA3ZA5vn0i9CsVCIquYkSu5MXsDJG6KU99SR2m6CEC4Z0YPeIJDhVZC1YiJ_CLwBMRitCiFKiDYhwR22GLqer5OOwwnxF_NH66nJjl2CTwfdyZj_sNxAf4vGzZYiImKLaj7nmm4EXz6i_dBCjqczScTFKSnH3NvgzTD8iTTbR" liveUrl="https://lumina-wellness.vercel.app" githubUrl="https://github.com/yourname/lumina-wellness" variants={itemVariants} />
        </motion.div>
      </motion.div>
    </section>
  );
